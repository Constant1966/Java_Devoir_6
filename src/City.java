...
public class City {
    ...
    static {
        ...
        weatherIcons.put("sunny", new ImageIcon("sun.png"));
        weatherIcons.put("cloudy", new ImageIcon("cloudy.png"));
        weatherIcons.put("rain", new ImageIcon("rain.png"));
        weatherIcons.put("snow", new ImageIcon("snowman.png"));
        weatherIcons.put("windy", new ImageIcon("windy.png"));
    }
